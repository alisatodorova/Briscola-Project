...
//        Card[] human = RandomHand.randomHand(cardsLeft, 3);
...
//        BigState brainState = new BigState(cardsLeft, two.getHand(), human, game.getHighSuit());
        BigState brainState = new BigState(cardsLeft, two.getHand(), game.getHighSuit());
        ;
...
//        Card cardTwo = two.playCard(two.alphaBeta(brainState, null));
        Card cardTwo = two.playCard(two.miniMax(brainState, null, one.getHand()));
//        ANNData aNN = new ANNData(cardsLeft, game.getHighSuit(), two.getHand(), null, cardTwo);
//        save.save(aNN);
...
//                brainState = new BigState(cardsLeft,two.getHand(),RandomHand.randomHand(cardsLeft,2), game.highSuit);
                brainState = new BigState(cardsLeft,two.getHand(), game.highSuit);

//                cardTwo = two.playCard(two.miniMax(brainState, cardOne));
//                cardTwo = two.playCard(two.alphaBeta(brainState, cardOne));
                 cardTwo = two.playCard(two.miniMax(brainState, cardOne, one.getHand()));
//                aNN = new ANNData(cardsLeft, game.getHighSuit(), two.getHand(), cardOne, cardTwo);
//                save.save(aNN);
...
//                brainState = new BigState(cardsLeft,two.getHand(),RandomHand.randomHand(cardsLeft, 3), game.highSuit);
                brainState = new BigState(cardsLeft,two.getHand(), game.highSuit);
//                cardOne = two.playCard(two.miniMax(brainState,null));
//                cardOne = two.playCard(two.alphaBeta(brainState,null));
                cardOne = two.playCard(two.miniMax(brainState,null,one.getHand()));
//                aNN = new ANNData(cardsLeft, game.getHighSuit(), two.getHand(), cardOne, cardTwo);
//                save.save(aNN);
//                System.out.println("\n\n\n\n\n\n");
